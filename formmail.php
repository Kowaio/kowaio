...
<html>
    <head>
	  ...
	  <meta http-equiv="refresh" content="2; URL=index.php?nom=contact">
...
if ($_POST["nom"]=="" && $_POST["prenom"]=="" && $_POST["dtnais"]=="" && $_POST["adr"]=="" && $_POST["cdpst"]=="" && $_POST["ville"]=="" && $_POST["tel"]=="" && $_POST["courriel"]=="" && $_POST["niveau"]=="") 
	exit(0);
//---- Si id du stage =1 alors c'est oui sinon id=2 donc non	
if ($_POST["stage"]=="1")
	$_POST["stage"]="Oui";
else $_POST["stage"]="Non";

//---- Si le domaine du stage est vide ou qu'il est remplie mais que l'utilisateur a spécifié Non pour le stage, le domaine est mis à Aucun	
if ($_POST["dstage"]=="" || $_POST["stage"]=="Non")	
	$_POST["dstage"]="Aucun";
//-------------------------------------
...
Niveau d'étude: $_POST[niveau]

Recherche de Stage : $_POST[stage]

Domaine du Stage : $_POST[dstage]"; 
